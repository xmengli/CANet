...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_classes=5, init_weights=True, crossCBAM=True):
        ...
        if self.crossCBAM:
            ...
            self.branch_bam1 = CBAM(512)
            self.branch_bam2 = CBAM(512)
            self.classifier_dep1 = nn.Linear(512*7*7, 1024)
            self.classifier_dep2 = nn.Linear(512*7*7, 1024)
